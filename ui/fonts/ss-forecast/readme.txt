...
For example, when displaying the weather forecast where the weather pattern is an icon:

    Today's forecast: <i class="ss-icon">sunny</i>

A sun symbol will be displayed alongside the text "Today's forecast: ".
